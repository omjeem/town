...
export function GroupChatPrompt() {
  ...
  // Only surface when at least one OTHER player is in the same house
  // — being alone in a room with NPCs is a 1-1 conversation, not a
  // group chat.
  if (state.othersHere <= 0) return null;
  return (
